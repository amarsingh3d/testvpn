...
public class AdobeTokens_EditorialTopicPage_TestCase {
	...
	public void FileReadBrowserLaunch(@Optional("Local_Chrome_Console") String browser, @Optional("https://reactqa2.smgdigitaldev.com") String url, @Optional("Not Required from Local") String name) throws Exception {
		System.out.println("Start Test Case: " + "AdobeTokens_EditorialTopicPage_TestCase");
	...
	@Test (priority = 5)
	@Parameters({"subPageType"})
	public void SubPageType(String subPageType){
		
		assertObjectsOnPagesObj.assertAdobeTokenProperty(BaseTestObj, "subPageType", subPageType);
	}
	...
	public void TerminateTestCase(){
		System.out.println("End Test Case: " + "AdobeTokens_EditorialTopicPage_TestCase");
